module InPlaceMacrosHelper
  ...
  def in_place_editor_field(object, method, tag_options = {}, in_place_editor_options = {})
    ### Modified by <tania@efaber.net> to work in Rails4
    # instance_tag = ::ActionView::Helpers::InstanceTag.new(object, method, self)
    instance_tag = ActionView::Helpers::Tags::TextArea.new(object, method, self)
    value = instance_tag.object.send(method)
    if value.nil?
      value = tag_options[:nil_content_replacement]
    end
    ### End of Modified by <tania@efaber.net>
