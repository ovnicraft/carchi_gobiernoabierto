module AutoCompleteMacrosHelper      
  ...
  #     @items = Item.where([ 'LOWER(description) LIKE ?', 
  ...
  def text_area_with_auto_complete_inline(object, method, tag_options = {}, completion_options = {})
    (completion_options[:skip_style] ? "" : auto_complete_stylesheet) +
    text_area(object, method, tag_options) +
  ...
  private
    ...
    ######## Added by <tania@efaber.net> to support array_or_string_for_javascript deprecation ########
    ...
    ######## End of Added by <tania@efaber.net> to support array_or_string_for_javascript deprecation ########
